...
$sql = sprintf("INSERT INTO `u887840871_news`.`%s` (`id`, `title`, `description`, `media`, `link`, `guid`, `pubDate`, `temperatura`, `latitud`, `longitud`) VALUES (NULL, %s, %s, %s, %s, %s, %s, %s, %s, %s);", 
				$mysqli->real_escape_string($params['tabla']), 
				$mysqli->real_escape_string($params['title']), 
				$mysqli->real_escape_string($params['description']), 
				$mysqli->real_escape_string($params['media']), 
